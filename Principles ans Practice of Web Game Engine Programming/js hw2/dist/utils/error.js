...
(function (ProcessState) {
    ...
    ProcessState[ProcessState["ERR_PASSWD"] = 2] = "ERR_PASSWD";
    ProcessState[ProcessState["ERR_ISBN"] = 3] = "ERR_ISBN";
    ProcessState[ProcessState["ERR_ID"] = 4] = "ERR_ID";
    ProcessState[ProcessState["ERR_COLLE"] = 5] = "ERR_COLLE";
    ProcessState[ProcessState["ERR_ISBN_DUPL"] = 6] = "ERR_ISBN_DUPL";
    ProcessState[ProcessState["ERR_ID_DUPL"] = 7] = "ERR_ID_DUPL";
    ProcessState[ProcessState["ERR_COLLE_DUPL"] = 8] = "ERR_COLLE_DUPL";
    ProcessState[ProcessState["ERR_ARGS_ALGO"] = 9] = "ERR_ARGS_ALGO";
    ProcessState[ProcessState["ERR_ARGS_PASSWD"] = 10] = "ERR_ARGS_PASSWD";
    ProcessState[ProcessState["ERR_ARGS_FNAME"] = 11] = "ERR_ARGS_FNAME";
    ProcessState[ProcessState["ERR_ARGS_BOOK"] = 12] = "ERR_ARGS_BOOK";
    ProcessState[ProcessState["ERR_ARGS_ID"] = 13] = "ERR_ARGS_ID";
    ProcessState[ProcessState["ERR_ARGS_COLLE"] = 14] = "ERR_ARGS_COLLE";
    ProcessState[ProcessState["ERR_UNKNOWN_CMD"] = 15] = "ERR_UNKNOWN_CMD";
