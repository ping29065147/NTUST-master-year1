...
def make_optimizer_class(cls):
    ...
    class DPOptimizerClass(cls):
        ...
        def compute_gradients(self, loss, var_list, gate_gradients=None, aggregation_method=None,
...
def make_gaussian_optimizer_class(cls):
    ...
    class DPGaussianOptimizerClass(make_optimizer_class(cls)):
        ...
        def __init__(self, l2_norm_clip, noise_multiplier, num_microbatches=None, ledger=None,
                     unroll_microbatches=False, *args, **kwargs):
            ...
            super(DPGaussianOptimizerClass, self).__init__(dp_sum_query, num_microbatches, unroll_microbatches, *args,
                                                           **kwargs)
